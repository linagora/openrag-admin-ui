...
>
	...
	<div class="relative flex flex-col">
		...
		>
			<span>
				{$partitions.length === 0 ? 'Create a partition' : 'Select or create a partition'}
			</span>
		...
		{:else}
			...
			<input
				id="partition-btn"
				class="hover:bg-sla-50 w-full cursor-pointer rounded-md border border-slate-200 px-4 py-2 text-left
	...
	<!-- Files upload input -->
	<div class="relative flex flex-col">
		<label class="mb-2 cursor-pointer font-medium" for="file-upload-btn">
		...
		>
			...
			{:else}
				...
				<div class="flex flex-col items-center justify-center">
					...
					/>
					<p class="text-slate-500 transition-colors group-hover:text-pink-500">
